...
countryCodeDF = pd.DataFrame(pd.read_csv("CountryCode.csv"))
...
requestPrDict = {"rqtype": "mavg", "rqvar": "pr", "start": str(2020), "end": str(2039)}
...
requesttempDict = {"rqtype": "mavg", "rqvar": "tas", "start": str(2020), "end": str(2039)}
